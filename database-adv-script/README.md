...
- `database-adv-script/analytics_views.sql`: Materialized views for host/property analytics
- `database-adv-script/performance_logging.sql`: Lightweight performance logging schema
...
3) Execute from the repo root (`alx-airbnb-database`):
   ...
   - `\i database-adv-script/analytics_views.sql`
